...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    int taskId;
    boolean isEdit;
    com.example.meditrack.Task task;
    ...
    com.example.meditrack.ReminderMainActivity activity;
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, com.example.meditrack.ReminderMainActivity activity){
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    private void createTask(){
        class saveTaskInBackend extends AsyncTask<Void,Void,Void>{
            ...
            protected Void doInBackground(Void... voids) {
                com.example.meditrack.Task createTask = new com.example.meditrack.Task();
                ...
                if (!isEdit)
                    com.example.meditrack.DatabaseClient.getInstance(getActivity()).getAppDatabase()
                            .dataBaseAction()
    ...
    public void createAnAlarm() {
        try {
            ...
            Intent alarmIntent = new Intent(activity, com.example.meditrack.AlarmBroadcastReceiver.class);
            ...
            alarmIntent.putExtra("EVENT",taskEvent.getText().toString());
    ...
    private void showTaskFromId() {
        class showTaskFromId extends AsyncTask<Void, Void, Void> {
            ...
            @Override
            protected Void doInBackground(Void... voids) {
                task = com.example.meditrack.DatabaseClient.getInstance(getActivity()).getAppDatabase()
