...
public class MainImageActivity extends AppCompatActivity {
    ...
    private static com.example.meditrack.GestureDetectGridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(MainImageActivity.this,R.color.background));
    ...
    private void init() {
        mGridView = (com.example.meditrack.GestureDetectGridView) findViewById(R.id.grid);
