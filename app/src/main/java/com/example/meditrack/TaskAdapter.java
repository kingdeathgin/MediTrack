...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    private com.example.meditrack.ReminderMainActivity context;
    private LayoutInflater inflater;
    private List<com.example.meditrack.Task> taskList;
    public SimpleDateFormat dateFormat = new SimpleDateFormat("EE dd MMM yyyy", Locale.US);
    public SimpleDateFormat inputDateFormat = new SimpleDateFormat("dd-M-yyyy", Locale.US);
    Date date = null;
    String outputDateString = null;
    com.example.meditrack.CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener;

    public TaskAdapter(com.example.meditrack.ReminderMainActivity context, List<com.example.meditrack.Task> taskList, com.example.meditrack.CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        com.example.meditrack.Task task = taskList.get(position);
    ...
    public void showPopUpMenu(View view, int position) {
        final com.example.meditrack.Task task = taskList.get(position);
        PopupMenu popupMenu = new PopupMenu(context, view);
        popupMenu.getMenuInflater().inflate(R.menu.menu_remind, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuUpdate:
                    com.example.meditrack.CreateTaskBottomSheetFragment createTaskBottomSheetFragment = new com.example.meditrack.CreateTaskBottomSheetFragment();
                    createTaskBottomSheetFragment.setTaskId(task.getTaskId(), true, (com.example.meditrack.CreateTaskBottomSheetFragment.setRefreshListener) context, context);
    ...
    public void showCompleteDialog(int taskId, int position) {
        Dialog dialog = new Dialog(context, R.style.Theme_MediTrack);
    ...
    private void deleteTaskFromId(int taskId, int position) {
        class GetSavedTasks extends AsyncTask<Void, Void, List<com.example.meditrack.Task>> {
            @Override
            protected List<com.example.meditrack.Task> doInBackground(Void... voids) {
                com.example.meditrack.DatabaseClient.getInstance(context)
                        .getAppDatabase()
                        .dataBaseAction()
            ...
            @Override
            protected void onPostExecute(List<com.example.meditrack.Task> tasks) {
